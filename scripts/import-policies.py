...
from docx_to_markdown import convert, header_table
...
def main():
    ...
    for d in DOCS:
        ...
        md = (
            ...
            f'group: "{d["group"]}"\n'
            f"order: {d['order']}\n"
            # Everything before section 1 is the header table and the internal
            # approval note; both are handled or dropped deliberately.
            "---\n\n" + convert(src, skip_until=r"^1\. ")
        )
